...
abstract class AbstractUri implements UriInterface
{
     ...
     * @return string|null
     */
    protected function formatScheme($scheme = null)
    {
     ...
     * when building the string representation</li>
     * </ul>
     *
     ...
     *
     * @param array $components a hash representation of the similar
    ...
    /**
     * Return the string representation as a reference.
     *
     * Depending on which components of the are present, the resulting
     * string is either a full or relative reference according to RFC 3986,
     ...
     * string.
     *
     * The authority syntax of the is:
     *
     * <pre>
     * [user-info@]host[:port]
     * </pre>
